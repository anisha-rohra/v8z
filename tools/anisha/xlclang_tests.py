...
class TestShellScript(unittest.TestCase):
    ...
    def test_nested_nonrec_main(self):
        os.system('xlclang -E -qmakedep tests/nested_nonrec/nested1/test.c > garbage.c')
    ...
    def test_nested_rec_main(self):
        os.system('xlclang -E -qmakedep tests/nested_rec/test.c > garbage.c')
        self.assertTrue(os.path.isfile('test.u'))
        self.assertTrue(os.path.isfile('garbage.c'))
    ...
    def test_include_rec_main(self):
        os.system('xlclang -E -qmakedep -I tests/include_paths_tests -I tests/include_paths_tests/test_recursive/included_path tests/include_paths_tests/test_recursive/actual_code/test.c > garbage.c')
        self.assertTrue(os.path.isfile('test.u'))
        self.assertTrue(os.path.isfile('garbage.c'))
    ...
    def test_include_nonrec_main(self):
        os.system('xlclang -E -qmakedep -I tests/include_paths_tests/test_nonrecursive/different_path tests/include_paths_tests/test_nonrecursive/test.c > garbage.c')
        self.assertTrue(os.path.isfile('test.u'))
        self.assertTrue(os.path.isfile('garbage.c'))
